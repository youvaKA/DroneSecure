...
async function loadDashboard() {
    try {
        ...
        const cooldownText = Number(cooldownRemaining) === 0 ? 'Prêt' : formatTime(Number(cooldownRemaining));
            ...
            try {
                ...
                if (owner.toLowerCase() === userAddress.toLowerCase()) {
                    ...
                    userMissions.push({
                        ...
                        lastTransferAt: Number(mission.lastTransferAt),
                        lockedUntil: Number(mission.lockedUntil),
                ...
                if (userMissions.length >= Number(balance)) {
                    break;
                }
            }
        }
